...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        String result = "None";
        // tie
        if ((grid[0][0] == 'x' || grid[0][0] == 'o') && (grid[0][1] == 'x' || grid[0][1] == 'o') && (grid[0][2] == 'x' || grid[0][2] == 'o')) {
            if ((grid[1][0] == 'x' || grid[1][0] == 'o') && (grid[1][1] == 'x' || grid[1][1] == 'o') && (grid[1][2] == 'x' || grid[1][2] == 'o')) {
                if ((grid[2][0] == 'x' || grid[2][0] == 'o') && (grid[2][1] == 'x' || grid[2][1] == 'o') && (grid[2][2] == 'x' || grid[2][2] == 'o')) {
                    result = "Tie";
                }
            }
        }
